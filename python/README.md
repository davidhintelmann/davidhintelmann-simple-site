...
This code will require folder called res in the directory parent to python folder (ie. like [this one](fat-umpalumpa.github.io)). res folder will have ids.json file for ID and oanda_api_key.json file for API token issued by Oanda.
